...
The engineers just need the __total calibration result__, which is the sum of the test values from just the equations that could possibly be true. In the above example, the sum of the test values for the three equations listed above is __`3749`__.
